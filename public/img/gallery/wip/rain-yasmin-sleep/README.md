...
### Attention! The content you will read below will contain vore (safe content)!
...
Some features of the image are incorrect (Especially the design of characters that does not match their official versions in the official wiki), as they will be fully corrected when drawn by an artist.
