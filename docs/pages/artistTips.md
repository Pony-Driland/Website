...
All art styles inevitably mix with the art style of other artists until it becomes an common art style. This effect is easier to be perceived in character poses where the probability of a same pose being repeated in various different art styles is higher. We do not realize this when drawing has many elements together with the character, but the drawings where the character is the focus of the drawing, makes it easier to be perceived.
