...
(function() {
    ...
    rainConfig.drops = $('<div>', { class: 'drop' }).append(

    );

    rainConfig.backDrops = $('<div>', { class: 'drop' }).append(
...
var openChapterMenu = function(params = {}) {
    ...
    const newRead = async function(chapter = 1, page = 1, line = null) {
        ...
        $('#markdown-read').append(
            ...
            // Table
            $('<table>', { class: 'table table-bordered table-striped' }).css('background-color', 'rgb(44 44 44)').append(table),
